...
| :------------------------------------------------------------ | :----: | :------: |
| [Algebra I](https://www.khanacademy.org/math/algebra)         |:ballot_box_with_check:|B.E. Curriculum|
| [Algebra II](https://www.khanacademy.org/math/algebra2)       |:ballot_box_with_check:|B.E. Curriculum|
| [Trigonometry](https://www.khanacademy.org/math/trigonometry) |:ballot_box_with_check:|B.E. Curriculum|
| [Precalculus](https://www.khanacademy.org/math/precalculus)   |:ballot_box_with_check:|B.E. Curriculum|
...
| Courses                                                                                                                                                               |   Status   |   Evidence   |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------: | :----------: |
| [Intro to JS: Drawing & Animation](https://www.khanacademy.org/computing/computer-programming/programming)                                                            |:ballot_box_with_check:|-|
| [Intro to HTML/CSS: Making webpages](https://www.khanacademy.org/computing/computer-programming/html-css)                                                             |:ballot_box_with_check:|-|
| [Intro to SQL: Querying and managing data](https://www.khanacademy.org/computing/computer-programming/sql)                                                            |:ballot_box_with_check:|-|
| [Advanced JS: Games & Visualizations](https://www.khanacademy.org/computing/computer-programming/programming-games-visualizations)                                    |            |              |
| [HTML/JS: Making webpages interactive](https://www.khanacademy.org/computing/computer-programming/html-css-js)                                                        |            |              |
| **Capstone**                                                                                                                                                          | **Status** | **Evidence** |
| Create a website highlighting what you learned and built during this tier. Use this as an opportunity to create a portfolio of your projects, notes, blog posts, etc. |            |              |

### Tier 0 - Web Development - Fullstack Bootcamp - ~~App Academy Open~~ Full Stack Open - University of Helsinki
...
| Courses                                                                                                                                                                                                |   Status   |   Evidence   |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------: | :----------: |
| [CS50's Introduction to Computer Science](https://www.edx.org/course/cs50s-introduction-computer-science-harvardx-cs50x)                                                                               |     :ballot_box_with_check:       |       [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#computer-science-basics)       |
| [How to Learn Math: For Students](https://www.edx.org/course/how-to-learn-math-for-students-2)                                                                                          |       :ballot_box_with_check:     |      [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#math)        |
| [CS50's Web Programming with Python and JavaScript](https://www.edx.org/course/cs50s-web-programming-with-python-and-javascript)                                                                       |            |              |
| Do this: [Single Variable Calculus](https://ocw.mit.edu/courses/mathematics/18-01sc-single-variable-calculus-fall-2010/) (more rigorous)                                                               |     :ballot_box_with_check:       |        B.E. Curriculum      |
| Or, this: [Khan Academy Calculus I](https://www.khanacademy.org/math/calculus-1) and [Khan Academy Calculus II](https://www.khanacademy.org/math/calculus-2) (a more gentle introduction)              |     :ballot_box_with_check:       |      B.E. Curriculum        |
| [Algorithms](https://www.khanacademy.org/computing/computer-science/algorithms)                                                                                                                        |       :ballot_box_with_check:     |        [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#theory)      |
...
| **Reading**                                                                                                                                                                                            | **Status** | **Evidence** |
| [MDN HTML - Advanced topics](https://developer.mozilla.org/en-US/docs/Web/HTML#Advanced_topics)                                                                                                        |      :ballot_box_with_check:      |              |
| [MDN CSS - Reference - Key Concepts](https://developer.mozilla.org/en-US/docs/Web/CSS#Reference)                                                                                                       |    :ballot_box_with_check:        |              |
| [MDN JavaScript - Tutorials - JavaScript Guide](https://developer.mozilla.org/en-US/docs/Web/JavaScript#JavaScript_guide)                                                                              |   :ballot_box_with_check:         |              |
...
| Courses                                                                                                                                                                                                            |   Status   |   Evidence   |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------: | :----------: |
| [Mathematics for Computer Science](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-042j-mathematics-for-computer-science-spring-2015/)                                                   |       :ballot_box_with_check:     |        [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#math) |
| [Introduction to Computer Science and Programming in Python](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-0001-introduction-to-computer-science-and-programming-in-python-fall-2016/) |     :ballot_box_with_check:       |       [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#computer-science-basics)       |
| [Introduction to Computational Thinking and Data Science](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-0002-introduction-to-computational-thinking-and-data-science-fall-2016/)       |      :ballot_box_with_check:      |      [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#computer-science-basics)        |
...
| [Intro to Algorithms](https://www.udacity.com/course/intro-to-algorithms--cs215)                                                                                                                                   |     :ballot_box_with_check:       |       [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#theory)       |
| [Introduction to Algorithms](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/)                                                                  |     :ballot_box_with_check:       |      [ForrestKnight/open-source-cs](https://github.com/VishalBot1/open-source-cs#theory)        |
| **Reading**                                                                                                                                                                                                        | **Status** | **Evidence** |
| [MDN JavaScript - Tutorials - Advanced](https://developer.mozilla.org/en-US/docs/Web/JavaScript#Advanced)                                                                                                          |      :ballot_box_with_check:      |              |
| [MDN HTTP - Tutorials](https://developer.mozilla.org/en-US/docs/Web/HTTP#Tutorials)                                                                                                                                |      :ballot_box_with_check:      |              |
| [MDN Web Components](https://developer.mozilla.org/en-US/docs/Web/Web_components)                                                                                                                                  |     :ballot_box_with_check:       |              |
